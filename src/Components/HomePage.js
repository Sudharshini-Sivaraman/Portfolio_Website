...
export function HomePage() {
  return (
    ...
    <p className="text-xl text-black mb-8 text-justify font-semibold italic sofia-font">Computer Science and Engineering Student at <br/>Francis Xavier Engineering College, Tirunelveli</p>
